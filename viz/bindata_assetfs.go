...
func indexTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.tmpl", size: 4946, mode: os.FileMode(420), modTime: time.Unix(1478881329, 0)}
...
func configJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "config.json", size: 529, mode: os.FileMode(420), modTime: time.Unix(1478011731, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
